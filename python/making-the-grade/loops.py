...
def student_ranking(student_scores, student_names):
    ...
    return [
        f"{rank}. {student_name}: {score}" for rank, (student_name, score) in enumerate(zip(student_names, student_scores), start=1)
    ]
    # I learned zip on my own!
...
def perfect_score(student_info):
    ...
    #My first attempt, but I can do better!
    """
